...
const FlexItem = styled.div`
  ${props => props.alignSelfXS && `align-self: ${props.alignSelfXS};`}
  ${props => props.flexBasisXS && `flex-basis: ${props.flexBasisXS};`}
  ${props => props.flexGrowXS && `flex-grow: ${props.flexGrowXS};`}
  ${props => props.flexShrinkXS && `flex-shrink: ${props.flexShrinkXS};`}
